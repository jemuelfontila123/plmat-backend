...
#english
Question.create(subcategory: "Grammar", difficulty: Question.difficulties[:medium], text: "I am sure I would have regretted it if I ________ to take the job." , questionnaire: english_questionnaire)
Question.create(subcategory: "Grammar", difficulty: Question.difficulties[:easy], text: "Suzie and John are planning to get married and ________ a lot of children." , questionnaire: english_questionnaire)
Question.create(subcategory: "Grammar", difficulty: Question.difficulties[:easy], text: "We ________ a lovely three weeks in the south of Spain last year." , questionnaire: english_questionnaire)
Question.create(subcategory: "Grammar", difficulty: Question.difficulties[:medium], text: "Please do not forget to ring me when you ________ home." , questionnaire: english_questionnaire)
